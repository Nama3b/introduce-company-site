...
//            })
     ...
     * .
     */
    private function buildAction($categoryPost): string
    {
        $action = Gate::allows(CategoryPost::EDIT) ? '<a href="javascript:void(0);" class="btn btn-light btn-xs d-inline-flex py-1 mx-1 inline_edit" data-id="' . $categoryPost->id . '">'
            ...
            . '</svg>'
            . '</a>' : '';
        $action .= Gate::allows(CategoryPost::DELETE) ? '<a href="javascript:void(0);" class="btn btn-light btn-xs d-inline-flex py-1 mx-1 inline_delete" data-id="' . $categoryPost->id . '" >'
            . '<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">'
     ...
     * @return string
     */
    private function checkbox($categoryPost): string
    {
